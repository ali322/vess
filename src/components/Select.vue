<template>
  <div>
    <div class="flex items-center h-25px rounded border-width-1px border-gray-300" ref="selectBtn">
      <span class="flex-1 w-60px px-2 text-size-14px" :class="{'text-gray-300': props.disabled}">{{ current }}</span>
    ...
    <teleport to="body">
      <div
        class="fixed bg-white shadow-md rounded pb-2 border-1 border-gray-200"
        v-show="focus"
        :style="dropdownStyle"
        ref="selectDropdown"
      >
